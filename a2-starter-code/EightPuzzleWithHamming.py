...
The Hamming Distance for the 8 tiles puzzle.
...
This code contains our implementation to find the Hamming Distance, 
...
class EightPuzzleWithHamming:
    """
    Class that implements the Hamming distance heuristic for the 8 tiles puzzle.
    """

    def __init__(self, problem):
        """ Initializing the Hamming Distance class.
